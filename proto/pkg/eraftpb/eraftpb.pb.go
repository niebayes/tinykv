...
func (EntryType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_5ea09887ef87b6f1, []int{0}
}
...
func (MessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_5ea09887ef87b6f1, []int{1}
}
...
const (
	...
	RejectReason_IndexConflict RejectReason = 1
	RejectReason_TermConflict  RejectReason = 2
)
...
func (RejectReason) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_5ea09887ef87b6f1, []int{2}
}

type DenyVoteReason int32

const (
	DenyVoteReason_GRANT DenyVoteReason = 0
	// I've voted for another one in this term.
	DenyVoteReason_VOTED DenyVoteReason = 1
	// My log is more update to date than you.
	DenyVoteReason_STALE DenyVoteReason = 2
)

var DenyVoteReason_name = map[int32]string{
	0: "GRANT",
	1: "VOTED",
	2: "STALE",
}
var DenyVoteReason_value = map[string]int32{
	"GRANT": 0,
	"VOTED": 1,
	"STALE": 2,
}

func (x DenyVoteReason) String() string {
	return proto.EnumName(DenyVoteReason_name, int32(x))
}
func (DenyVoteReason) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_5ea09887ef87b6f1, []int{3}
}
...
func (ConfChangeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_5ea09887ef87b6f1, []int{4}
}
...
type Entry struct {
	...
	// term, index are populated by the raft module.
	// entry_type and data are populated by the upper application.
...
type Message struct {
	...
	// in leader election: true if from node has rejected to grant the vote.
	// in log replication: true if from node has rejected to append entries.
	Reject               bool           `protobuf:"varint,10,opt,name=reject,proto3" json:"reject,omitempty"`
	Reason               RejectReason   `protobuf:"varint,11,opt,name=reason,proto3,enum=eraftpb.RejectReason" json:"reason,omitempty"`
	DenyReason           DenyVoteReason `protobuf:"varint,12,opt,name=deny_reason,json=denyReason,proto3,enum=eraftpb.DenyVoteReason" json:"deny_reason,omitempty"`
	NextIndex            uint64         `protobuf:"varint,13,opt,name=next_index,json=nextIndex,proto3" json:"next_index,omitempty"`
...
func (m *Message) GetReason() RejectReason {
	if m != nil {
		return m.Reason
	}
...
func (m *Message) GetDenyReason() DenyVoteReason {
	if m != nil {
		return m.DenyReason
	}
	return DenyVoteReason_GRANT
}

func (m *Message) GetNextIndex() uint64 {
	if m != nil {
		return m.NextIndex
	}
	return 0
...
func (m *Message) GetConflictTerm() uint64 {
	if m != nil {
...
func (*ConfState) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_5ea09887ef87b6f1, []int{5}
}
...
func (*ConfChange) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_5ea09887ef87b6f1, []int{6}
}
...
func init() {
	...
	proto.RegisterEnum("eraftpb.RejectReason", RejectReason_name, RejectReason_value)
	proto.RegisterEnum("eraftpb.DenyVoteReason", DenyVoteReason_name, DenyVoteReason_value)
...
func (m *Message) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Reason != 0 {
		dAtA[i] = 0x58
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.Reason))
	}
	if m.DenyReason != 0 {
		dAtA[i] = 0x60
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.DenyReason))
	}
	if m.NextIndex != 0 {
		dAtA[i] = 0x68
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.NextIndex))
	}
	if m.ConflictTerm != 0 {
		dAtA[i] = 0x70
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.ConflictTerm))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *Message) Size() (n int) {
	...
	if m.Reason != 0 {
		n += 1 + sovEraftpb(uint64(m.Reason))
	}
	if m.DenyReason != 0 {
		n += 1 + sovEraftpb(uint64(m.DenyReason))
	}
	if m.NextIndex != 0 {
		n += 1 + sovEraftpb(uint64(m.NextIndex))
	}
	if m.ConflictTerm != 0 {
		n += 1 + sovEraftpb(uint64(m.ConflictTerm))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 11:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Reason |= (RejectReason(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 12:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DenyReason |= (DenyVoteReason(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConflictTerm", wireType)
			}
			m.ConflictTerm = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ConflictTerm |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("eraftpb.proto", fileDescriptor_eraftpb_5ea09887ef87b6f1) }

var fileDescriptor_eraftpb_5ea09887ef87b6f1 = []byte{
	// 805 bytes of a gzipped FileDescriptorProto
	,
}
